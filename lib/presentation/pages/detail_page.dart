            ...
            children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          BorderIconWidget(width: 140, height:  50,child: Text("20 Hours ago",style: themeData.textTheme.headline5,),padding: const EdgeInsets.symmetric(vertical: 15,horizontal: 15),)
                        ],
                      ),
                    ),
                    addVerticalSpace(padding),
              ...
              Positioned(
                ...
                child: Row(
                  ...
                  children: [
                    OptionButtonWidget(text: "Message",icon: Icons.message,width: size.width*0.35,),
                    addHorizontalSpace(10),
                    OptionButtonWidget(text: "Call",icon: Icons.call,width: size.width*0.35,),
                  ],
                ),
              )
            ],
